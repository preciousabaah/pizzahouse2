...
<!--main class="main-content  mt-0">
  <section class="min-vh-100 mb-8">
    <div class="page-header align-items-start min-vh-50 pt-5 pb-11 m-3 border-radius-lg" style="background-image: url('/img/pizza3.webp');">
          ...
          <div class="card z-index-0">
            ...
            <div class="card-body">
              <form role="form text-left" action="{{ route('register') }}" method="POST">
                @csrf
                <div class="mb-3">
                  <input type="text" name="name" class="form-control" placeholder="Name" aria-label="Name" aria-describedby="email-addon" required value="{{ old('name') }}">
                </div>
                <div class="mb-3">
                ...
                <div class="form-check form-check-info text-left">
                  <input class="form-check-input" type="checkbox" name="checkbox" value="1" id="flexCheckDefault" checked>
      ...
      <div class="row">
        <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
          <div class="card card-plain mt-8">
            <div class="card-header pb-0 text-left bg-transparent">
              ...
              <p class="mb-0">Fill in your details to sign up</p>
            </div>
            ...
            <div class="card-body">
              ...
              <div class="d-flex">
                <div>
                <a href="default.asp"><img src="/img/google.png" alt="google image" style="width:42px;height:42px;"></a>
                </div>

                 <div class="">
                <a href="default.asp"><img src="/img/facebook.webp" alt="facebook image" style="width:62px;height:62px;"></a>
                </div>
              </div>
        ...
        <div class="col-md-6">
          <div class="oblique position-absolute top-0 h-100 d-md-block d-none me-n8">
            <div class="oblique-image bg-cover position-absolute fixed-top ms-auto h-100 z-index-0 ms-n6" style="background-image:url('/img/pizzahouse.png')"></div>
          </div>
        </div>
      </div>
    </div>
